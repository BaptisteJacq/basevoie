/*
La table TA_LIBELLE - du projet C de correction de la latéralité des voies - liste les types et états permettant de catégoriser les objets de la base voie.
*/
