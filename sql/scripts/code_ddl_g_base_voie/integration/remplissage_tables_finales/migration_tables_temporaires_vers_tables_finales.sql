...
BEGIN
    ...
    */
    ...
    EXECUTE IMMEDIATE 'ALTER TABLE G_BASE_VOIE.TA_VOIE_ADMINISTRATIVE DISABLE CONSTRAINT TA_VOIE_ADMINISTRATIVE_FID_RIVOLI_FK';
    ...
    EXECUTE IMMEDIATE 'DROP INDEX TA_VOIE_ADMINISTRATIVE_FID_VOIE_SUPRA_COMMUNALE';
    EXECUTE IMMEDIATE 'DROP INDEX TA_VOIE_ADMINISTRATIVE_LOG_ID_VOIE_SUPRA_COMMUNALE';
    ...
    EXECUTE IMMEDIATE 'DROP INDEX TA_VOIE_PHYSIQUE_LOG_ID_VOIE_PHYSIQUE';
...
-- 2. Sélection des métadonnées de la base voie de la MEL afin de créer une valeur par défaut pour le champ fid_metadonnee de TA_TRONCON et TA_VOIE_ADMINISTRATIVE
...
-- 2.2. Modification des codes DDL de TA_TRONCON et TA_VOIE_ADMINISTRATIVE
    EXECUTE IMMEDIATE 'ALTER TABLE G_BASE_VOIE.TA_TRONCON MODIFY FID_METADONNEE NUMBER(38,0) DEFAULT ' || v_mtd;
    EXECUTE IMMEDIATE 'ALTER TABLE G_BASE_VOIE.TA_VOIE_ADMINISTRATIVE MODIFY FID_METADONNEE NUMBER(38,0) DEFAULT ' || v_mtd;
...
-- 4. Insertion du code fantoir dans TEMP_VOIEVOI
    ...
    */
    ...
    EXECUTE IMMEDIATE 'ALTER TRIGGER B_IUD_TA_VOIE_ADMINISTRATIVE_LOG DISABLE';
    ...
    -- 21. Import de toutes les voies valides et invalides dans TA_VOIE_ADMINISTRATIVE
    ...
    -- 22. Mise à jour de la clé étrangère TA_VOIE_ADMINISTRATIVE.FID_RIVOLI 
    ...
    -- 23. Import dans la table TA_VOIE_ADMINISTRATIVE_LOG des données de TA_VOIE_ADMINISTRATIVE
...
-- 23.4. Pour la suppression des voies de type foie ferrée, canal et ruisseau
    ...
    -- 24. Suppression des voies invalides dans la table TA_VOIE_ADMINISTRATIVE
    DELETE
    FROM
    ...
    WHERE
        objectid IN(
            ...
            FROM
                G_BASE_VOIE.TEMP_VOIEVOI a
                INNER JOIN G_BASE_VOIE.TA_VOIE_ADMINISTRATIVE b ON b.objectid = a.ccomvoi
            WHERE
                a.cdvalvoi = 'I'
        );
    ...
    EXECUTE IMMEDIATE 'ALTER TRIGGER B_IUX_TA_VOIE_ADMINISTRATIVE_DATE_PNOM ENABLE';
    ...
    WHERE
        TABLE_NAME = 'TA_RELATION_TRONCON_VOIE'
        AND R_CONSTRAINT_NAME = 'TA_VOIE_ADMINISTRATIVE_PK';
...
*/
    ...
    FROM
        ...
        INNER JOIN G_BASE_VOIE.TA_VOIE_ADMINISTRATIVE c ON c.objectid = b.ccomvoi,
...
-- 38. Insertion des points d'intérêt
    ...
    EXECUTE IMMEDIATE 'CREATE INDEX TA_VOIE_ADMINISTRATIVE_FID_TYPEVOIE_IDX ON G_BASE_VOIE.TA_VOIE_ADMINISTRATIVE(fid_typevoie) TABLESPACE G_ADT_INDX';
    ...
    EXECUTE IMMEDIATE 'CREATE INDEX TA_VOIE_ADMINISTRATIVE_FID_METADONNEE_IDX ON G_BASE_VOIE.TA_VOIE_ADMINISTRATIVE(fid_metadonnee) TABLESPACE G_ADT_INDX';
